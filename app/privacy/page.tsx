        ...
        <div className="space-y-8 text-slate-300">
          ...
          <section>
            ...
            <div className="pl-10">
              ...
              <ul className="list-disc pl-6 space-y-2 text-slate-400">
                <li><strong className="text-slate-300">Prestación del Servicio:</strong> Generar casos de prueba, gestionar tu cuenta y proporcionar las funcionalidades contratadas.</li>
                <li><strong className="text-slate-300">Mejora del Servicio:</strong> Analizar patrones de uso para optimizar la experiencia del usuario y desarrollar nuevas funcionalidades.</li>
                <li><strong className="text-slate-300">Comunicaciones:</strong> Enviar notificaciones relacionadas con el servicio, actualizaciones y cambios en los términos.</li>
                <li><strong className="text-slate-300">Seguridad:</strong> Detectar, prevenir y responder ante actividades fraudulentas o no autorizadas.</li>
                <li><strong className="text-slate-300">Cumplimiento Legal:</strong> Cumplir con obligaciones legales y responder a requerimientos de autoridades competentes.</li>
              </ul>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="pl-10">
              ...
              <ul className="list-disc pl-6 mt-2 space-y-2 text-slate-400">
                <li><strong className="text-slate-300">Ejecución contractual:</strong> El tratamiento es necesario para la prestación del servicio que has contratado.</li>
                <li><strong className="text-slate-300">Consentimiento:</strong> Al registrarte y utilizar el servicio, otorgás tu consentimiento libre, expreso e informado.</li>
                <li><strong className="text-slate-300">Interés legítimo:</strong> Para mejorar nuestros servicios y garantizar la seguridad de la plataforma.</li>
              </ul>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="pl-10 space-y-3">
              ...
              <ul className="list-disc pl-6 space-y-2 text-slate-400">
                <li><strong className="text-slate-300">Encriptación en tránsito:</strong> Todas las comunicaciones utilizan protocolo HTTPS/TLS.</li>
                <li><strong className="text-slate-300">Encriptación en reposo:</strong> Los datos almacenados están cifrados en servidores seguros.</li>
                <li><strong className="text-slate-300">Autenticación segura:</strong> Utilizamos OAuth 2.0 a través de Google para la autenticación.</li>
                <li><strong className="text-slate-300">Infraestructura:</strong> Nuestros datos se alojan en servidores de Supabase y Vercel con certificaciones de seguridad.</li>
                <li><strong className="text-slate-300">Acceso restringido:</strong> Solo personal autorizado tiene acceso a los datos personales.</li>
              </ul>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="pl-10 space-y-3">
              ...
              <ul className="list-disc pl-6 space-y-2 text-slate-400">
                <li><strong className="text-slate-300">Proveedores de servicios esenciales:</strong> Supabase, Vercel, Stripe, Anthropic y Google.</li>
                <li><strong className="text-slate-300">Autoridades competentes:</strong> Cuando sea requerido por ley, orden judicial o requerimiento de autoridad pública.</li>
              </ul>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="pl-10 space-y-3">
              ...
              <ul className="list-disc pl-6 space-y-2 text-slate-400">
                <li><strong className="text-slate-300">Acceso:</strong> Solicitar información sobre los datos personales que tenemos sobre vos.</li>
                <li><strong className="text-slate-300">Rectificación:</strong> Corregir datos inexactos o incompletos.</li>
                <li><strong className="text-slate-300">Supresión:</strong> Solicitar la eliminación de tus datos cuando ya no sean necesarios.</li>
                <li><strong className="text-slate-300">Actualización:</strong> Mantener tus datos actualizados.</li>
              </ul>
