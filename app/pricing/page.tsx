      ...
      <main className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-400 max-w-2xl mx-auto">
            ...
            Comenzá gratis y actualizá cuando quieras.
          </p>
        </div>
        ...
        <div className="flex items-center justify-center gap-4 mb-12">
          ...
          <button
            ...
            className={`relative w-14 h-7 rounded-full transition-colors ${
              billing === "yearly" ? "bg-violet-600" : "bg-slate-700"
            }`}
          >
            <div
          ...
          <div className="space-y-4">
            <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-5">
              ...
              <p className="text-slate-400 text-sm">
                Sí, podés actualizar o cancelar tu plan cuando quieras. Si actualizás, 
                se te cobrará la diferencia prorrateada.
              </p>
            </div>
            ...
            <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-5">
              ...
              <p className="text-slate-400 text-sm">
                El plan Free es completamente funcional y no tiene límite de tiempo. 
                Podés usarlo indefinidamente con 20 generaciones diarias.
              </p>
            </div>
            ...
            <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-5">
              ...
              <p className="text-slate-400 text-sm">
                El contador se reinicia cada 24 horas. Si necesitás más generaciones, 
                considerá actualizar al plan Pro.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 text-center">
          ...
          <a href="mailto:soporte@testcraft.ai" className="text-violet-400 hover:text-violet-300">
            soporte@testcraft.ai
          </a>
        </div>
      </main>
