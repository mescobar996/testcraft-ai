                ...
                <div className="px-4 pb-4 max-w-4xl mx-auto">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-slate-800 border border-slate-600 rounded-lg text-white placeholder:text-slate-500 focus:outline-none focus:border-yellow-500"
                    />
                  </div>
                </div>
              )}
                  ...
                  <div className="space-y-3">
                    {filteredFavorites.map((record) => (
                      <div
                        ...
                        className="group bg-slate-900 hover:bg-slate-800 border border-slate-700 hover:border-yellow-500/50 rounded-xl p-5 cursor-pointer transition-all"
                      >
