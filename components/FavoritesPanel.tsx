          ...
          <div className="relative w-full sm:w-[95%] sm:max-w-4xl h-[90vh] sm:h-[80vh] bg-slate-900 border border-slate-700 rounded-t-2xl sm:rounded-2xl shadow-2xl flex flex-col overflow-hidden">
            ...
            <div className="flex items-center justify-between p-4 border-b border-slate-700 bg-slate-900 flex-shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-bold text-white">Casos Favoritos</h2>
                  <p className="text-xs text-slate-400">{favorites.length} guardados</p>
                </div>
              </div>
              ...
              <div className="p-4 border-b border-slate-800 flex-shrink-0">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-3 bg-slate-800 border border-slate-700 rounded-xl text-white placeholder:text-slate-500 focus:outline-none focus:border-yellow-500"
                  />
                </div>
              </div>
            )}
                ...
                <div className="space-y-2">
                  {filteredFavorites.map((record) => (
                    <div
                      ...
                      className="group bg-slate-800/50 hover:bg-slate-800 border border-slate-700 hover:border-yellow-500/50 rounded-xl p-4 cursor-pointer transition-all"
                    >
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <ChevronRight className="w-4 h-4 text-slate-500 group-hover:text-yellow-400" />
                        </div>
                      </div>
                    </div>
                  ))}
